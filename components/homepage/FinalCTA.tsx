      ...
      <Container className="relative z-10">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-0">
          <AnimatedSection direction="up">
            ...
            >
              Ready to <GradientText gradient="accent" className="text-white bg-gradient-to-r from-accent via-accent-dark to-accent bg-clip-text text-transparent">Master</GradientText> Power BI?
            </motion.h2>
            <motion.p 
            ...
            >
              Join thousands who have advanced their careers with Power BI skills. Start your journey today with our comprehensive course.
            </motion.p>
            <motion.div 
